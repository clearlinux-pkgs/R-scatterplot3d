...
Source0  : https://cran.r-project.org/src/contrib/scatterplot3d_0.3-44.tar.gz
...
%prep
%setup -q -n scatterplot3d
pushd ..
cp -a scatterplot3d buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683303399
